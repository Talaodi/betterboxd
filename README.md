...
- **设计理念: 一切数据均可通过 AI 查询**. 这是贯穿项目的核心原则, 而非某个单项功能: 观影记录, 影评, 想看与喜欢, 清单与成员, 统计项目, 历史对话, 值池标签 -- 每一种数据都会为 AI 准备一个查询工具. 由此得到的收益是稳定的: AI 输出的每个数字都能回溯到工具返回, 准确度被这条设计兜住, 不受模型状态波动影响.
